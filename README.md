...
На этом основная часть описания программы для рядового пользователя окончена. Далле будет придставлено подробное описание работы каждой из функций, для многоуважаемого Untronix0nly.
